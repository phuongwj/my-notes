...
- [Heading over to IAM Dashboard](#heading-over-to-iam-dashboard)

- [Over-billing Story](#over-billing-story)
  + [What to do when you set up a service an you suddenly gets a massive bill](#what-to-do-when-you-set-up-a-service-and-you-suddenly-gets-a-massive-bill)
...
- You can either pick *Autogenerated password* or *Custom password* for the *Console password* section. After that, go ahead click *Next*. 
...
> **Aside -- Information about Policies:**
...
Since we already have a story on over-billing, we'll go over steps to protect yourself from it. 
