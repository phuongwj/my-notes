...
* Lecture discussions: __Nov 25, 2025__
...
* Continuing server-side scripting with __PHP__
  * __Continuation:__
    * To do list
  * __New topic:__
    * Cookies and Sessions for working with persistent data
    * Customizing data in web page based on cookies and sessions
      * We will try to create a preference storage mechanism (`font-family`) using Cookies
      * We will try to create a simple login/logout mechanism using Sessions
